// functions.cpp.cpp : Implementation of the functions.cpp class
...
HRESULT functions.cpp::LoadFromStream(IStream* pStream, DWORD grfMode)
{
...
void functions.cpp::InitializeSearchContent()
{
...
void functions.cpp::SetSearchContent(CString& value)
{
...
void functions.cpp::OnDrawThumbnail(HDC hDrawDC, LPRECT lprcBounds)
{
